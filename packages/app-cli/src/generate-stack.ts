...
export interface StackFileInput {
  ...
  readonly cwd: string;
  /** Absolute path to the discovered `prisma-app.config.ts` — imported by relative path. */
...
/** A relative import specifier from `.prisma-app/alchemy.run.ts` to `target` (posix separators). */
