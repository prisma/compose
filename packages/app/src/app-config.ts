 ...
 * a `service` control is an error naming (extension, type, expected kind).
 */
...
/** Typed identity — exists so `prisma-app.config.ts` gets checked against PrismaAppConfig where it is written. */
