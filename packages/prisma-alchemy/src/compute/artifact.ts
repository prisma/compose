 ...
 * (not in @makerkit/prisma-cloud/target) because it needs node:fs/node:zlib,
...
function createDeterministicTarGz(entries: readonly { relPath: string; content: Buffer }[]): Buffer {
