...
This is the tech stack for building **AppKit** (the TypeScript framework) and its supporting toolchain, plus the
...
- **Distribution:** npm packages (AppKit as a library + companion packages)
