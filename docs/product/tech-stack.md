...
This is the tech stack for building **MakerKit** (the TypeScript framework) and its supporting toolchain, plus the
...
- **Distribution:** npm packages (MakerKit as a library + companion packages)
