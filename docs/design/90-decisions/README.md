...
- [ADR-0013](ADR-0013-resources-are-provisioned-by-hexes-deps-are-declarations.md) — Resources are provisioned by hexes; a service's deps are declarations (a dual-form value describes its own via `Dependable`).
