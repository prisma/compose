...
This document captures the "always happening" flows: dev, deploy, request handling, and binding resolution. Kept high-signal for MakerKit relevance.
...
- **Assumption**: HTTP and cron are the primary ingress patterns for MakerKit comparison; queues and Durable Objects are secondary.
