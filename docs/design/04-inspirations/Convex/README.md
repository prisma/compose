...
The intent is to keep "how Convex works" relatively static here, while keeping "what MakerKit should do because of it" in a separate takeaways doc that we can revise as our own design evolves.
