...
The intent is to keep "how Wrangler works" relatively static here, while keeping "what MakerKit should do because of it" in a separate takeaways doc that we can revise as our own design evolves.
...
- `domain-map.md`: a conceptual relationship map of the domain (includes Mermaid)
