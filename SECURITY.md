...
When the framework reaches 1.0 this section will be revised; the supported-versions story will be more conservative.
...
When a fix lands, the corresponding advisory will be published via [GitHub Security Advisories](https://github.com/prisma/compose/security/advisories) and may be assigned a CVE.
